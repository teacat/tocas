...
<p>你可以變換留言中時間和文字的位置，這些在下面都有範例可供參考。</p>
...
留言可以是一個主題性質，這將允許你的留言帶有層級制度，留言中可帶有子留言。

```html
<div class="ts [[threaded]] comments">
    <div class="comment">
        <a class="avatar">
            <img src="!-user-!">
        </a>
...
留言可以帶有分隔線區分來和下一個留言做區分。

```html
<div class="ts [[divided]] comments">
    <div class="comment">
        <a class="avatar">
            <img src="!-user-!">
        </a>
