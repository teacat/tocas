    ...
    [
        {
            type       : large,
            title      : '說明',
            description: 'Tocas UI 所採用動畫效果是來自於 MIT 授權的 <a href="https://daneden.github.io/animate.css/">Animate.css</a>。'
        },
        {
            type             : normal,
            anchor           : 'include',
            title            : '總略大綱',
            description      : '這裡將解釋如何使用 Tocas UI 動畫和其統整。',
            link             : false,
        ...
        {
            type: source,
            code: `<div class="fade in left">我等一下會從左淡入喔！</div>`
        },
        {
            type       : small,
            title      : '執行動畫',
        ...
        },
        {
            ...
            code: `<div class="fade in left">我等一下會從左淡入喔！</div>
<br>
<button class="ts animation example button">按我示範</button>`,
            mark  : 'fade in left'
        },
        {
            type       : normal,
