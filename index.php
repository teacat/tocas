...
<meta name="twitter:description" content="一個 HTML5 和 CSS3 的網站設計元素。">
<meta name="twitter:image" content="http://tocas-ui.com/img/tocas-og.png">
<!-- / Twitter -->

<!-- Facebook -->
<meta property="og:title" content="Tocas UI">
<meta property="og:type" content="article">
<meta property="og:image" content="http://tocas-ui.com/img/tocas-og.png">
<meta property="og:url" content="http://tocas-ui.com/">
<meta property="og:image:width" content="1280">
<meta property="og:image:height" content="720">
<meta property="og:description" content="一個 HTML5 和 CSS3 的網站設計元素。">
<!-- / Facebook -->

<!-- Icon -->
<link rel="apple-touch-icon" sizes="57x57" href="http://tocas-ui.com/img/favicons/apple-touch-icon-57x57.png">
<link rel="apple-touch-icon" sizes="60x60" href="http://tocas-ui.com/img/favicons/apple-touch-icon-60x60.png">
<link rel="apple-touch-icon" sizes="72x72" href="http://tocas-ui.com/img/favicons/apple-touch-icon-72x72.png">
<link rel="apple-touch-icon" sizes="76x76" href="http://tocas-ui.com/img/favicons/apple-touch-icon-76x76.png">
<link rel="apple-touch-icon" sizes="114x114" href="http://tocas-ui.com/img/favicons/apple-touch-icon-114x114.png">
<link rel="apple-touch-icon" sizes="120x120" href="http://tocas-ui.com/img/favicons/apple-touch-icon-120x120.png">
<link rel="apple-touch-icon" sizes="144x144" href="http://tocas-ui.com/img/favicons/apple-touch-icon-144x144.png">
<link rel="apple-touch-icon" sizes="152x152" href="http://tocas-ui.com/img/favicons/apple-touch-icon-152x152.png">
<link rel="apple-touch-icon" sizes="180x180" href="http://tocas-ui.com/img/favicons/apple-touch-icon-180x180.png">
<link rel="icon" type="image/png" href="http://tocas-ui.com/img/favicons/favicon-32x32.png" sizes="32x32">
<link rel="icon" type="image/png" href="http://tocas-ui.com/img/favicons/favicon-194x194.png" sizes="194x194">
<link rel="icon" type="image/png" href="http://tocas-ui.com/img/favicons/favicon-96x96.png" sizes="96x96">
<link rel="icon" type="image/png" href="http://tocas-ui.com/img/favicons/android-chrome-192x192.png" sizes="192x192">
<link rel="icon" type="image/png" href="http://tocas-ui.com/img/favicons/favicon-16x16.png" sizes="16x16">
<link rel="manifest" href="http://tocas-ui.com/img/favicons/manifest.json">
<link rel="mask-icon" href="http://tocas-ui.com/img/favicons/safari-pinned-tab.svg" color="#5bbad5">
<meta name="apple-mobile-web-app-title" content="Tocas UI">
<meta name="application-name" content="Tocas UI">
<meta name="msapplication-TileColor" content="#00aba9">
<meta name="msapplication-TileImage" content="http://tocas-ui.com/img/favicons/mstile-144x144.png">
...
<div class="ts main container">
    ...
    <div class="ts stackable grid">
        ...
        <div class="eight wide column example">
            ...
            <h3 class="ts header">SASS</h3>
            
            <!-- 原始碼 -->
            <pre class="ts segment" style="margin-bottom: 40px"><code class="sass">.ts.button.sakura
       +button-theme(#FFB7C5, #7F5961)</code></pre>
            <!-- / 原始碼 -->
            ...
            <!-- 原始碼 -->
            <pre class="ts segment code" data-important-class="sakura"></pre>
            <!-- / 原始碼 -->
            
            <!-- 預覽 -->
            <div class="preview">
                <button class="ts fluid sakura button">羽田白音</button>
            </div>
            <!-- / 預覽 -->
    ...
    <div class="ts relaxed stackable grid">
        ...
        <div class="four wide column">
            ...
            <div class="ts vertical positive menu">
                ...
                <a class="item"><span class="fa fa-star"></span> 收藏</a>
            ...
            <!-- 使用者清單 -->
            <h4 class="ts header">使用者清單</h4>
            
            <div class="ts divided relaxed items">
                <div class="item">
                    <div class="image">
            ...
            <div class="ts segment">
                <div class="ts comments">
                    <div class="comment">
                        ...
                        <div class="content">
                            <div class="author">infinity-G™☆3日目東ユ46b</div>
                            
                            <div class="inline text">
                                入稿版冬コミ新作ブランケットです。よろしくね。 
                            </div>
                            <div class="metadata">
                                <div class="ts horizontal middoted thin link list">
                                  <a class="item">
                                    Dec 13
                                  </a>
                                </div>
                    ...
                    <div class="comment">
                        ...
                        <div class="content">
                            <div class="author">いんふぃ™☆3日目東ユ-46b</div>
        ...
        <div class="ts stackable grid">
            ...
            <div class="four wide column">
                ...
                <div class="ts inverted link list">
                    <a class="item" href="http://www.infinity-s.jp/">Infinity-G</a>
...
file_put_contents('index.html', htmlCompress($content));
?>