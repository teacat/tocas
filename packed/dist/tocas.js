...
(function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			slot = element("slot");
    			this.c = noop;
    			add_location(slot, file$1, 64, 4, 1730);
    			attr_dev(div, "class", "ts-accordion");
    			toggle_class(div, "ts-accordion--multiple", isTrue(/*multiple*/ ctx[2]));
    			toggle_class(div, "ts-accordion--divided", isTrue(/*divided*/ ctx[0]));
    			toggle_class(div, "ts-accordion--compact", /*density*/ ctx[1] === "compact");
    			toggle_class(div, "ts-accordion--relaxed", /*density*/ ctx[1] === "relaxed");
    			add_location(div, file$1, 56, 0, 1453);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*isTrue, multiple*/ 4) {
    				toggle_class(div, "ts-accordion--multiple", isTrue(/*multiple*/ ctx[2]));
    			}

    			if (dirty & /*isTrue, divided*/ 1) {
    				toggle_class(div, "ts-accordion--divided", isTrue(/*divided*/ ctx[0]));
    			}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [divided, density, multiple, factory, expandAll];
    }
    ...
    class Accordion extends SvelteElement {
    	...
    	static get observedAttributes() {
    		return ["divided", "density", "multiple", "expandAll"];
    	}
    	...
    	set expandAll(value) {
    		throw new Error("<ts-accordion>: Cannot set read-only property 'expandAll'");
    	}
    }
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(slot, file, 113, 16, 3834);
    			attr_dev(div, "class", "ts-accordion-item__title__main__header");
    			add_location(div, file, 112, 12, 3764);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, slot);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(slot, file, 118, 16, 4028);
    			attr_dev(div, "class", "ts-accordion-item__title__main__description");
    			add_location(div, file, 117, 12, 3953);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, slot);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(117:12) {#if $$slots.description}",
    		ctx
    	});
    ...
    // (125:4) {#if $$slots.content && isTrue(expanded)}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(slot, file, 126, 8, 4232);
    			attr_dev(div, "class", "ts-accordion-item__content");
    			add_location(div, file, 125, 4, 4182);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, slot);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(125:4) {#if $$slots.content && isTrue(expanded)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let t1;
    	let t2;
    	let show_if = /*$$slots*/ ctx[3].content && isTrue(/*expanded*/ ctx[0]);
    	let factory_action;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			set_custom_element_data(ts_icon, "icon", ts_icon_icon_value = isTrue(/*expanded*/ ctx[0])
    			? "chevron-down"
    			: "chevron-up");

    			add_location(ts_icon, file, 108, 12, 3571);
    			attr_dev(div0, "class", "ts-accordion-item__title__icon");
    			add_location(div0, file, 107, 8, 3513);
    			attr_dev(div1, "class", "ts-accordion-item__title__main");
    			add_location(div1, file, 110, 8, 3672);
    			attr_dev(div2, "class", "ts-accordion-item__title");
    			add_location(div2, file, 106, 4, 3447);
    			attr_dev(div3, "class", "ts-accordion-item");
    			toggle_class(div3, "ts-accordion-item--expanded", isTrue(/*expanded*/ ctx[0]));
    			add_location(div3, file, 101, 0, 3317);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*expanded*/ 1 && ts_icon_icon_value !== (ts_icon_icon_value = isTrue(/*expanded*/ ctx[0])
    			? "chevron-down"
    			: "chevron-up")) {
    			...
    			if (dirty & /*$$slots, expanded*/ 9) show_if = /*$$slots*/ ctx[3].content && isTrue(/*expanded*/ ctx[0]);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<ts-accordion-item> was created with unknown prop '${key}'`);
    	});
    	...
    	return [expanded, toggle, factory, $$slots, collapse];
    }
    ...
    class AccordionItem extends SvelteElement {
    	...
    	set collapse(value) {
    		throw new Error("<ts-accordion-item>: Cannot set read-only property 'collapse'");
    	}
    }
