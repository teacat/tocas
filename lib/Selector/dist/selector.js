...
$_ = function(selector, context) {
  var nodes;
  nodes = [];
  if (typeof selector === 'string' && context === void 0) {
...
$_.fn = {
  ...
  parent: function(selector) {
    var ref;
    return $_((ref = this.get()) != null ? ref.parentNode : void 0);
  },
  closest: function(selector) {
    var ref;
    return $_((ref = this.get()) != null ? ref.closest(selector) : void 0);
  },
  find: function(selector) {
    var elements;
    elements = [];
    this.each(function() {
      return this.querySelectorAll(selector).forEach(function(element) {
