  ...
  class TocasRating {
    ...
    _init({$this, $options, $module}, {rating, maxRating, interactive}) {
      ...
      $this.find('.icon').on('touchend', function(e) {
        var $lastIcon, clearable, currentRating;
        // 取得是在哪個圖示放開觸控的。
        ...
        if (rating === currentRating) {
          ...
          if (clearable === true || (clearable === 'auto' && $this.children().length === 1)) {
            // 重設評分為零。
    ...
    $init({$this, $options, $module}) {
      ...
      config = {
        ...
        interactive: $this.attr('data-interactive') || $options.interactive
      };
