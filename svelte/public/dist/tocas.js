...
(function () {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(slot, file, 121, 16, 3956);
    			attr_dev(div, "class", "ts-accordion-item__title__main__header");
    			add_location(div, file, 120, 12, 3886);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, slot);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(slot, file, 126, 16, 4150);
    			attr_dev(div, "class", "ts-accordion-item__title__main__description");
    			add_location(div, file, 125, 12, 4075);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, slot);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(125:12) {#if $$slots.description}",
    		ctx
    	});
    ...
    // (133:4) {#if $$slots.content && expanded}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(slot, file, 134, 8, 4346);
    			attr_dev(div, "class", "ts-accordion-item__content");
    			add_location(div, file, 133, 4, 4296);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, slot);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(133:4) {#if $$slots.content && expanded}",
    		ctx
    	});
